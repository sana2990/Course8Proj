...
Add necessary environment variables to the .env file, such as database connection URLs, API keys, or other sensitive data.
Add your own MongoDB Atlas URI in the datbase file inside the backend folder.
